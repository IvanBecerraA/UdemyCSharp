...
MyList<People> poeple = new MyList<People>(5);
poeple.Add(new People() { Name = "Héctor", Country = "México" });
poeple.Add(new People() { Name = "Juan", Country = "Argentina" });


Console.WriteLine(numbers.GetString());
Console.WriteLine(strings.GetString());
Console.WriteLine(poeple.GetString());
